...
class ErrorCode(StrEnum):
    ...
    INVALID_ZONE_GEOMETRY = "INVALID_ZONE_GEOMETRY"
    ZONE_ID_STALE = "ZONE_ID_STALE"
    NET_ASSIGNMENT_MISMATCH = "NET_ASSIGNMENT_MISMATCH"
    POST_ROUTE_PERSIST_FAILED = "POST_ROUTE_PERSIST_FAILED"
    POST_ZONE_PERSIST_FAILED = "POST_ZONE_PERSIST_FAILED"
    DUPLICATE_REFS = "DUPLICATE_REFS"
    POST_ROUTE_REFILL_SKIPPED = "POST_ROUTE_REFILL_SKIPPED"
