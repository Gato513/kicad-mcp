...
# Sesión 41 (DT1 slice 1): los encoders ad-hoc viven en pcb_encoders.py. Se
# re-exportan las siete con alias redundante (marca de re-export intencional,
# PEP 484) para preservar íntegra la superficie privada previa de este módulo:
# tests/test_pcb_encoders_golden.py y tests/test_pcb_session38_filter_desc.py
# importan cinco de ellas desde acá. Una sentencia por símbolo (no un bloque
# multilínea): el isort de ruff, en su configuración default de este
# proyecto (`combine-as-imports` no está seteado), separa cada `as` de un
# import multilínea en su propia sentencia — este es el resultado ya
# estable de esa normalización, no una elección de estilo.
from .pcb_encoders import _encode_component_detail as _encode_component_detail
from .pcb_encoders import _encode_tracks as _encode_tracks
from .pcb_encoders import _encode_zones as _encode_zones
from .pcb_encoders import _sanitize_space_delimited as _sanitize_space_delimited
from .pcb_encoders import _tracks_filter_desc as _tracks_filter_desc
from .pcb_encoders import _zone_is_axis_aligned_rect as _zone_is_axis_aligned_rect
from .pcb_encoders import _zones_filter_desc as _zones_filter_desc
